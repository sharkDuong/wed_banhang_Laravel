                        ...
                        <div class="mn-login-form">
                            <form action="{{ route('auth.register.post') }}" method="post">
                                ...
                                <span class="mn-login-wrap mb-3">
                                    ...
                                    <span class="mn-login-wrap mb-3">
                                        <label>Email</label>
                                        <input value="" class="mb-0" type="email" name="email" placeholder="Nhập email...">
                                        @error('email')
                                            <span class="text-danger text-small">* {{ $message }}</span>
                                        @enderror
                                    </span> <span class="mn-login-wrap mb-3">
                                        ...
                                        @error('password_confirmation')
                                            <span class="text-danger text-small">* {{ $message }}</span>
                                        @enderror
                                    </span> <span class="mn-login-wrap mn-login-btn">
                                        <span><a href="{{ route('auth.login.index') }}" class="">Đăng nhập?</a></span>
