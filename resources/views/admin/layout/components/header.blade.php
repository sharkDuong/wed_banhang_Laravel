            ...
            <ul class="list-unstyled">
                ...
                <li class="dropdown pc-h-item"><a class="pc-head-link dropdown-toggle arrow-none me-0"
                    ...
                    <div class="dropdown-menu dropdown-menu-end pc-h-dropdown"><a href="#!" class="dropdown-item"><i
                                class="ti ti-user"></i> <span>My Account</span> </a><a href="#!"
                            class="dropdown-item"><i class="ti ti-settings"></i> <span>Settings</span> </a><a href="#!"
                            class="dropdown-item"><i class="ti ti-headset"></i> <span>Support</span>
                        </a><a href="#!" class="dropdown-item"><i class="ti ti-lock"></i> <span>Lock Screen</span>
                        </a><a href="#!" class="dropdown-item"><i class="ti ti-power"></i> <span>Logout</span></a>
                    </div>
                </li>
                ...
                <li class="dropdown pc-h-item"><a class="pc-head-link dropdown-toggle arrow-none me-0"
                    ...
                    <div class="dropdown-menu dropdown-notification dropdown-menu-end pc-h-dropdown">
                        ...
                        <div class="text-center py-2"><a href="#!" class="link-danger">Clear all Notifications</a>
                        </div>
                    </div>
                </li>
                        ...
                        <div class="dropdown-body">
                            <div class="profile-notification-scroll position-relative"
                                ...
                                <div class="d-flex mb-1">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h6 class="mb-1">Carson Darrin 🖖</h6><span><a
                                                ...
                                                data-cfemail="2e4d4f5c5d4140004a4f5c5c47406e4d41435e4f4057004741">[email&#160;protected]</a></span>
                                    </div>
                                </div>
                                ...
                                <div class="card border-0 shadow-none drp-upgrade-card mb-0"
                                    style="background-image: url(https://ableproadmin.com/assets/images/layout/img-profile-card.jpg)">
                                    <div class="card-body">
                                        <div class="user-group"><img
                                                src="https://ableproadmin.com/assets/images/user/avatar-1.jpg"
                                        ...
                                        </h3><a href="#" class="btn btn btn-warning buynowlinks"><svg
                                                class="pc-icon me-2">
                                                <use xlink:href="#custom-logout-1-outline"></use>
        ...
        <div class="card mb-3">
            <div class="card-body">
                ...
                <p class="text-muted">Able Pro is completely renowed with high aesthetics User Interface.</p><img
                    src="https://ableproadmin.com/assets/images/layout/img-announcement-1.png" alt="img"
            ...
            <div class="card-body">
                ...
                <p class="text-muted">Download Able Pro exclusive on themeforest with best price.</p><a
                    href="https://1.envato.market/zNkqj6" target="_blank"><img
                        src="https://ableproadmin.com/assets/images/layout/img-announcement-2.png" alt="img"
                        class="img-fluid"></a>
            </div>
        </div>
        ...
        <div class="card mb-3">
            <div class="card-body">
                ...
                <p class="text-muted">Do you know Able Pro is one of the featured dashboard template selected by
                    <span class="tf">Themeforest</span> <span class="ct">Codedthemes</span> team.?
                </p><img src="https://ableproadmin.com/assets/images/layout/img-announcement-3.png" alt="img"
                    class="img-fluid">
            </div>
        </div>
        <div class="card mb-3">
            <div class="card-body">
                ...
                <p class="text-muted">Get the lifetime free updates once you purchase the Able Pro.</p><img
                    src="https://ableproadmin.com/assets/images/layout/img-announcement-4.png" alt="img"
                    class="img-fluid">
            </div>
        </div>
    </div>
